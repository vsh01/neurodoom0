...
//   +  medkit   p  stimpack   A  armour   c  bullets   S  shells
//   G  shotgun  C  chaingun   k  red keycard   o  barrel   L  floor lamp
...
const THING_CHARS = {
  ...
  c: { kind: 'item', type: 'clip' },
  S: { kind: 'item', type: 'shells' },
  G: { kind: 'item', type: 'shotgun' },
  C: { kind: 'item', type: 'chaingun' },
